...
describe('GET /api/v1/users/names', () => {
  it('returns display names for the requested user IDs', async () => {
    ...
    const req = new NextRequest(
      'http://localhost:3000/api/v1/users/names?ids=11111111-1111-4111-8111-111111111111,22222222-2222-4222-8222-222222222222',
    );
    const res = await GET(req);

    expect(res.status).toBe(200);
    expect(requireAuthenticatedUserIdMock).toHaveBeenCalledTimes(1);
    expect(resolveUserDisplayNamesMock).toHaveBeenCalledWith([
