...
export function ComplianceUrgencySection() {
  return (
    <section id="compliance" className="bg-white px-6 py-16 sm:py-20">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            <div className="mb-4 inline-flex items-center gap-2 rounded-md bg-blue-50 px-3 py-1.5">
        ...
        <div className="mt-10 rounded-lg border border-red-200 bg-red-50 p-6">
          <div className="flex flex-col gap-6 md:flex-row md:items-start">
            <div className="flex-1">
              ...
              <ul className="mt-3 space-y-2 text-sm text-red-700">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 block h-1 w-1 shrink-0 rounded-full bg-red-400" />
                  <span>
            ...
            <div className="shrink-0 md:text-right">
              <a
                href="/signup"
                className="inline-flex items-center rounded-md bg-red-700 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-red-800"
              >
                Get Compliant Now
              </a>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {requiredDocuments.map((doc) => (
              ...
              >
                ...
                <p className="mt-0.5 text-xs text-gray-500">{doc.examples}</p>
              </div>
            ))}
          </div>
        </div>
...
function TimelineItem({ title, description, status }: TimelineItemProps) {
  const statusConfig = {
    ...
    exempt: {
      ...
      label: 'Exempt',
      labelColor: 'text-gray-600 bg-gray-50 border-gray-200',
    },
  };
