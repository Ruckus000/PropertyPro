          ...
          >
            <div className="min-w-0 flex-1 space-y-1">
              ...
              <input
                ...
                className="w-full rounded-sm border border-default px-3 py-2 text-base focus:border-interactive focus:outline-none focus:ring-2 focus:ring-interactive disabled:opacity-50"
              />
            </div>
            <button
              type="submit"
