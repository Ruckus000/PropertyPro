        ...
        {categoryMeta && !showSearch ? (
          ...
          <div className="relative">
            ...
            <input
              ...
              className="h-8 w-full rounded-[var(--radius-sm)] border border-edge bg-surface-card pl-8 pr-3 text-sm text-content placeholder:text-content-tertiary focus:border-interactive focus:outline-none focus:ring-1 focus:ring-focus"
