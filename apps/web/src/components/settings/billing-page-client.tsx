              ...
              <div className="flex flex-wrap gap-2">
                ...
                {hasStripe && (
                  <button
                    ...
                    onClick={openPortal}
                    disabled={portalPending}
                    className="inline-flex items-center gap-1.5 rounded-[10px] border border-edge bg-surface-card px-4 py-2 text-sm font-medium text-content transition-colors hover:bg-surface-hover disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    Manage Subscription
                    <ExternalLink size={14} aria-hidden="true" />
                  </button>
...
function QuickLink({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="flex w-full items-start gap-3 rounded-[10px] border border-edge p-4 text-left transition-colors hover:bg-surface-hover disabled:cursor-not-allowed disabled:opacity-50"
    >
