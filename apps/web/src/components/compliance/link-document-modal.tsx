  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Search */}
        <div className="relative px-4 py-3 border-b border-[var(--border-subtle)]">
          <Search size={14} className="absolute left-7 top-1/2 -translate-y-1/2 text-[var(--text-tertiary)]" />
          <input
            ref={inputRef}
            type="text"
            value={query}
        ...
        <div className="flex-1 overflow-y-auto min-h-[200px]">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              <FileText size={24} className="text-[var(--text-tertiary)] mb-2" />
              <p className="text-sm text-[var(--text-secondary)]">No matching documents</p>
            </div>
          ) : (
