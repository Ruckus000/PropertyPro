        ...
        <Card key={r.id} className="p-4">
          ...
          {denyDraftId === r.id && (
            <div className="mt-3 space-y-2 border-t pt-3">
              ...
              <textarea
                id={`deny-notes-${r.id}`}
                className="w-full min-h-[72px] rounded-md border border-edge bg-surface-card px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus"
