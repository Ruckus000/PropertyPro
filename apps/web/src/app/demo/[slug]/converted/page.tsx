      ...
      <div className="w-full max-w-md rounded-lg border border-[var(--border-default)] bg-[var(--surface-card)] p-8 text-center shadow-sm">
        ...
        <div className="space-y-4 text-left">
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-[var(--text-primary)]">Set your password via welcome email</p>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-[var(--text-primary)]">Invite your first residents</p>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-[var(--text-primary)]">Configure community settings</p>
            </div>
          </div>
        </div>
      </div>
