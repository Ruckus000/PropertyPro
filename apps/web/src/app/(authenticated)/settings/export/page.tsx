    ...
    <>
      ...
      <div className="space-y-6">
        ...
        */}
        ...
        {/*
          The full archive. Its worker resumes across invocations — see
          export-worker.ts for how the volume cursor and the within-table cursor
          each avoid re-writing work already done.
        */}
